const de = {
    ...
    phrases: {
        ...
        most_read_in: 'Meist gelesen {in} {n} {time} {keyword}.',
        most_popular_books: 'Am beliebtesten Thema.',
        my_profile: 'Mein Profil',
        noDataAvailable: 'Keine Daten verfügbar',
        our_history: 'Unsere Geschichte',
        our_plan: 'Unser Plan',
        pdpl_agree: "Sind Sie einverstanden? PDPL über {pdpl}",
    ...
    title: "Umlaufbahn des Zauberers",
    // Contents 👇👇👇👇👇👇👇👇👇👇👇👇
    chapter: {
        new: 'Neues Kapitel'
    },
